...
# %bb.0:
	...
	xor	a0, a2, a0
	slli	a0, a0, 3
	lui	a2, %hi(crc_32_tab)
	addi	a2, a2, %lo(crc_32_tab)
	add	a0, a2, a0
	ld	a0, 0(a0)
	srli	a1, a1, 8
	xor	a0, a0, a1
...
# %bb.1:                                # %.preheader
	...
	li	s5, -1
	srli	s4, s5, 32
	lui	a0, %hi(crc_32_tab)
	addi	s6, a0, %lo(crc_32_tab)
...
# %bb.0:
	li	a2, -1
	srli	a2, a2, 32
	lui	a3, %hi(crc_32_tab)
	addi	a3, a3, %lo(crc_32_tab)
	beqz	a1, .LBB2_2
